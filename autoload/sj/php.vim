...
function! sj#php#SplitIfClause()
  return sj#shared#SplitCurlyBracketIfClause(g:splitjoin_php_if_clause_curly_braces)
endfunction

function! sj#php#JoinIfClause()
  return sj#shared#JoinCurlyBracketIfClause(g:splitjoin_php_if_clause_curly_braces)
endfunction
